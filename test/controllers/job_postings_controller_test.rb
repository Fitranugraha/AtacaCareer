...
class JobPostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_posting" do
    assert_difference('JobPosting.count') do
      post job_postings_url, params: { job_posting: { code: @job_posting.code, description: @job_posting.description, expired_date: @job_posting.expired_date, position: @job_posting.position, post_date: @job_posting.post_date, requirement: @job_posting.requirement } }
    end
  ...
  test "should update job_posting" do
    patch job_posting_url(@job_posting), params: { job_posting: { code: @job_posting.code, description: @job_posting.description, expired_date: @job_posting.expired_date, position: @job_posting.position, post_date: @job_posting.post_date, requirement: @job_posting.requirement } }
