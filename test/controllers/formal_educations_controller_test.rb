...
class FormalEducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formal_education" do
    assert_difference('FormalEducation.count') do
      post formal_educations_url, params: { formal_education: { certification: @formal_education.certification, department: @formal_education.department, end_date: @formal_education.end_date, faculty: @formal_education.faculty, institution: @formal_education.institution, level: @formal_education.level, profile_id: @formal_education.profile_id, start_date: @formal_education.start_date } }
    end
  ...
  test "should update formal_education" do
    patch formal_education_url(@formal_education), params: { formal_education: { certification: @formal_education.certification, department: @formal_education.department, end_date: @formal_education.end_date, faculty: @formal_education.faculty, institution: @formal_education.institution, level: @formal_education.level, profile_id: @formal_education.profile_id, start_date: @formal_education.start_date } }
