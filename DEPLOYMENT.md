...
sudo service unicorn_AtacaCareer <start|stop|restart>
sudo service sidekiq_AtacaCareer <start|stop>
```
...
```
/home/deployer/apps/AtacaCareer/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_AtacaCareer restart
sudo service sidekiq_AtacaCareer stop
sudo service sidekiq_AtacaCareer start
```
